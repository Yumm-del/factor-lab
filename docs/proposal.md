...
- **关键实证（2026-08 真实 baostock 数据）**：AI 因子 3 年策略年化 **+14.4% vs 沪深300 +8.2%**；经典因子库 91 个（10 教科书 + **81 个 WorldQuant 101 公式移植**，与公开参考实现 48 公式逐日相关交叉验证、27 个全 >0.99，见 6.1.2）；AI 独立挖出的低波动因子与经典因子库表达式**完全一致**——可信度互证；双股票池（沪深300 + 全 A 5320 只）同管线对照实证，结论连同池子/窗口/口径一起解读；
