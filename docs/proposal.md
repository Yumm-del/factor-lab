...
- **关键实证（2026-08，双环境交叉验证）**：原始 AI「放量延续」在本地样本内策略年化 +14.4%，但在 BigQuant 动态沪深300、周频 Top-30、20bps 成本复核中年化 −2.45%，**未通过接纳门槛并被淘汰**；低波动作为经典对照在 BigQuant 发现期 5 日 RankIC +0.0546、留出期转弱，触发生命周期风险提示（见 6.2）。
...
<div class="kpi-grid">
  ...
  <div class="kpi"><div class="kpi-num">+0.0546</div><div class="kpi-label">低波动发现期 5 日 RankIC（BigQuant）</div></div>
